                    ...
                    {(booking.status === BookingStatus.PENDING || booking.status === BookingStatus.IN_REVIEW) && (
                        <div className="flex flex-col gap-2 justify-center border-l border-slate-100 pl-0 md:pl-6">
                            <button 
                                ...
                                className="flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg font-bold text-sm transition-colors shadow-sm w-full md:w-auto"
                            >
                            ...
                            {booking.status === BookingStatus.PENDING && (
                                <button 
                                    ...
                                    className="text-xs text-slate-500 hover:text-ipb-blue underline mt-2 text-center"
                                >
